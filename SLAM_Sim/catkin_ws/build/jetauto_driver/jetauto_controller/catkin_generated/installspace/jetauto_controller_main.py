...
class JetAutoController:
    def __init__(self):
        ...
        self.go_factor = rospy.get_param('~omni/go_factor', 1.00)
        self.turn_factor = rospy.get_param('~omni/turn_factor', 1.00)   
    ...
    def load_calibrate_param(self, msg):
        self.go_factor = rospy.get_param('~motor_speed_factor', 1.00)
